...
public class AIInstructions : MonoBehaviour
{
    ...
    AIInstructions()
    {
        ...
        instruction.Enqueue("... ... ...");
        instruction.Enqueue("Hello Monsieur. It is good to be working again...");
        ...
        history.Enqueue("and ... ... ... I do not have any data entry within those years' gap. It is very strange... My last data is when you finished the __SPHERE__ project and had her working as you desired.");
